    ...
    <div class="row">
        <div class="col-sm-12 col-md-6 col-xs-12">
            <ul class="list-inline" style="font-size: 12px">
                <li><a href="#"><span><b>Llámanos:</b> +57 (4) 444 8910</span></a></li>
        ...
        <div class="col-sm-12 col-md-6 col-xs-12">
            <div class="text-right loginbuttons">
               <!--  <a class="btn waves-effect waves-light btn-sm btn-success" href="limited-offers.html" title=""><i class="fa fa-gift"></i> Oferta limitada</a> -->
                <a class="btn waves-effect waves-light btn-sm btn-pink" href="combo_oferta.php" title=""><i class="fa fa-gift"></i> Combos </a>
                <a class="btn waves-effect waves-light btn-sm btn-default" href="#" title=""> Crear cuenta</a>
                <a class="btn waves-effect waves-light btn-sm btn-blue" href="clientes/" title=""><i class="fa fa-sign-in"></i> Iniciar sesión</a>
            </div>
        </div>
    </div>
</section>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <p>Hosting o alojamiento web es el servicio mediante el cual se hace realidad la visibilidad de tu sitio o aplicativo web. <br>
                                                En <b>giweb</b>  ofrecemos hosting a corde de las necesidades de tu negocio o perfil.</p>
                                        </div>
                                ...
                                <div class="yamm-content">
                                    <div class="row">
                                        ...
                                        <a href="email_pymes.php">
                                            <div class="col-lg-6">
                                              <img src="https://documentation.open-xchange.com/7.8.2/assets/img/ox_logopackage/left/ox_logo_white.png" height="25px" alt="">
