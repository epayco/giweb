<?php
/* Smarty version 3.1.29, created on 2017-10-31 15:18:59
  from "/home/runcloud/webapps/web-giweb/clientes/templates/iconhostwhmcs/knowledgebase.tpl" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_59f8dab31a9773_55765331',
  'file_dependency' => 
  array (
    '068cd6ad1f30ab4f873e815f0bdee36727d00b17' => 
    array (
      0 => '/home/runcloud/webapps/web-giweb/clientes/templates/iconhostwhmcs/knowledgebase.tpl',
      1 => 1503883252,
      2 => 'file',
    ),
  ),
...
function content_59f8dab31a9773_55765331 ($_smarty_tpl) {
if (!is_callable('smarty_modifier_truncate')) require_once '/home/runcloud/webapps/web-giweb/clientes/vendor/smarty/smarty/libs/plugins/modifier.truncate.php';
?>
<form role="form" method="post" action="<?php echo $_smarty_tpl->tpl_vars['WEB_ROOT']->value;?>
/knowledgebase.php?action=search">
    <div class="input-group knowledge">
        <input type="text" name="search" class="form-control" placeholder="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['kbsearchexplain'];?>
" />
        <span class="input-group-btn">
            <input type="submit" class="btn btn-lg btn-primary btn-input-padded-responsive" value="<?php echo $_smarty_tpl->tpl_vars['LANG']->value['search'];?>
" />
        </span>
    </div>
</form>
